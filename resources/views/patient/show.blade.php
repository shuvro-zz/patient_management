    ...
    <div class="container col-md-6 col-md-offset-3">
            <div class="well well bs-component">
                <div class="content">
                    ...
                    <p style="font-size: larger;"> <span style="font-weight: bold;">Blood Group: </span>{!! $patient->bloodGroup !!} </p>
                
                    <p style="font-size: larger;"> <span style="font-weight: bold;">List of Disease: </span>{!! $patient->disease !!} </p>
                    <p style="font-size: larger;"> <span style="font-weight: bold;">List of Allergies: </span>{!! $patient->allergy !!} </p>
                    <p style="font-size: larger;"> <span style="font-weight: bold;">Medicines: </span> {!! $patient->medicine !!} </p>
                    <p style="font-size: larger;"> <span style="font-weight: bold;">Diagnosis: </span>{!! $patient->diagnosis!!} </p>
